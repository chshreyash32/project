...
# ==========================================
# 2. CUSTOM CSS (PREMIUM MINIMALIST DARK + BIG BUTTONS)
# ==========================================
st.markdown("""
<style>
    /* GLOBAL THEME */
    ...
    .stButton > button {
        ...
        text-transform: uppercase; /* Make text CAPS */
        letter-spacing: 1px;
        box-shadow: 0 4px 6px rgba(0, 123, 255, 0.3); /* Subtle Blue Shadow */
    }
    ...
    div.stButton.stop-btn > button {
        ...
        box-shadow: 0 4px 6px rgba(255, 23, 68, 0.3);
    }
    div.stButton.stop-btn > button:hover {
...
def page_home():
    ...
    with c1:
        ...
        st.markdown("<p style='text-align: center;'>Login to view attendance or Register</p>", unsafe_allow_html=True)
        # Button is now styled via CSS to be big and visible
        if st.button("CONTINUE AS STUDENT"): navigate_to("student_hub")
    
    with c2:
        st.markdown("<h3 style='text-align: center;'>👨‍🏫 Faculty Login</h3>", unsafe_allow_html=True)
        st.markdown("<p style='text-align: center;'>Mark attendance and view reports</p>", unsafe_allow_html=True)
